...
const MealCard = ({meal, onCardClick, onShoppingCartClick}: MealCardProps) => {
  return (
    <div
      key={meal.idMeal}
      className="flex flex-col grow-0 justify-between md:mt-2 items-center my-2 rounded-lg shadow-lg shadow-gray-500 bg-primary-dark cursor-pointer w-38 lg:w-64 max-h-96"
    >
      <div
      ...
      <div className="p-4 flex flex-col grow justify-between text-start w-full">
        <p className="text-base md:text-lg mb-2 font-bold leading-relaxed text-gray-100">
          {meal.strMeal}
        </p>

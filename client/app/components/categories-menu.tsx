...
interface CategoriesMenyProps {
  categories: Category[];
  categoriesLoading: boolean;
  notAvailableCategories: boolean;
  onCategoryClick: (category: Category) => void;
}

const categoriesTesting =[
  {
    idCategory: "1",
    strCategory: "Beef",
...
const CategoriesMenu = ({
  ...
  return <div className="hidden lg:flex left-0">CategoriesMenu</div>;
};
